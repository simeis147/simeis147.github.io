import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as s,c as r,e as i,f as e,d as l,w as c,b as n}from"./app-f06f37c3.js";const u={},o=n('<h1 id="linux-day01" tabindex="-1"><a class="header-anchor" href="#linux-day01" aria-hidden="true">#</a> Linux-Day01</h1><h2 id="_1-前言" tabindex="-1"><a class="header-anchor" href="#_1-前言" aria-hidden="true">#</a> 1. 前言</h2><h3 id="_1-1-什么是linux" tabindex="-1"><a class="header-anchor" href="#_1-1-什么是linux" aria-hidden="true">#</a> 1.1 什么是Linux</h3><p>Linux是一套免费使用和自由传播的操作系统。</p><h3 id="_1-2-为什么要学linux" tabindex="-1"><a class="header-anchor" href="#_1-2-为什么要学linux" aria-hidden="true">#</a> 1.2 为什么要学Linux</h3><p><strong>1.</strong> 企业用人要求</p><p>为什么作为javaEE开发工程师，企业还要求我们会Linux操作系统的相关知识呢?</p><p>这是因为Linux操作系统提供了很多稳定的发行版本，广泛的应用在各种服务器操作系统领域，我们将来开发出来的项目，最终要上线运行，就需要将项目部署在Linux服务器中。</p><p><strong>2.</strong> 个人发展需要</p><p>作为javaEE开发工程师，将来在企业中开发时会涉及到很多的数据库、中间件等技术，比如MySQL、Redis、MQ等技术，而这些应用软件大多都是需要安装在Linux系统中使用的。我们做为开发人员，是需要通过远程工具连接Linux操作系统，然后来操作这些软件的。而且一些小公司，可能还需要我们自己在服务器上安装这些软件。</p><p>所以，不管从企业的用人需求层面，还是个人发展需要层面来讲，我们作为服务端开发工程师，Linux的基本使用是我们必不可少的技能。</p><h3 id="_1-3-学完linux能干什么" tabindex="-1"><a class="header-anchor" href="#_1-3-学完linux能干什么" aria-hidden="true">#</a> 1.3 学完Linux能干什么</h3><figure><img src="https://simeis147-github-io.oss-cn-shenzhen.aliyuncs.com/project/reggietakeout/03linux/20230605132241.png" alt=" " tabindex="0" loading="lazy"><figcaption></figcaption></figure><p><strong>1</strong>. 环境搭建</p><p>系统安装 : 一般我们不会直接将Linux系统安装在本机电脑上，而会安装在公司的一台专门的服务器上。</p><p>远程连接 : 要想使用服务器，一般都是通过远程连接工具连接Linux系统进行操作。</p><p><strong>2</strong>. 常用命令</p><p>连接上服务器之后，可以通过所学习的相关指令，来操作Linux服务器，在Linux服务器中可以执行如下操作：</p><p>A. 文件、目录的基本操作(查看,删除,创建等)</p><p>B. 文件及文件夹的拷贝、移动、重命名</p><p>C. 文件的打包、压缩、解压缩操作</p><p>D. 文本的编辑</p><p><strong>3</strong>. 安装软件</p><p>基本的常用指令学会操作之后，可以在Linux服务器中安装我们开发常用的软件，比如： JDK、Tomcat、MySQL的安装及配置。</p><p><strong>4</strong>. 项目部署</p><p>把基础的软件及环境安装配置好之后，可以将开发的项目部署在服务器中进行运行并测试。</p>',26),h=n(`<h2 id="_2-linux简介" tabindex="-1"><a class="header-anchor" href="#_2-linux简介" aria-hidden="true">#</a> 2. Linux简介</h2><h3 id="_2-1-主流操作系统" tabindex="-1"><a class="header-anchor" href="#_2-1-主流操作系统" aria-hidden="true">#</a> 2.1 主流操作系统</h3><p>不同领域的主流操作系统，主要分为以下这么几类： 桌面操作系统、服务器操作系统、移动设备操作系统、嵌入式操作系统</p><ol><li><p>桌面操作系统</p><table><thead><tr><th>操作系统</th><th>特点</th></tr></thead><tbody><tr><td>Windows</td><td>用户数量最多</td></tr><tr><td>MacOS</td><td>操作体验好，办公人士首选</td></tr><tr><td>Linux</td><td>用户数量少(桌面操作系统,Linux使用较少)</td></tr></tbody></table></li><li><p>服务器操作系统</p><table><thead><tr><th>操作系统</th><th>特点</th></tr></thead><tbody><tr><td>Unix</td><td>安全、稳定、付费</td></tr><tr><td>Linux</td><td>安全、稳定、免费、占有率高</td></tr><tr><td>Windows Server</td><td>付费、占有率低</td></tr></tbody></table></li><li><p>移动设备操作系统</p><table><thead><tr><th>操作系统</th><th>特点</th></tr></thead><tbody><tr><td>Android</td><td>基于 Linux 、开源，主要用于智能手机、平板电脑和智能电视</td></tr><tr><td>IOS</td><td>苹果公司开发、不开源，用于苹果公司的产品，例如：iPhone、 iPad</td></tr></tbody></table></li><li><p>嵌入式操作系统</p><table><thead><tr><th>操作系统</th><th>特点</th></tr></thead><tbody><tr><td>Linux</td><td>机顶盒、路由器、交换机</td></tr></tbody></table></li></ol><h3 id="_2-2-linux发展历史" tabindex="-1"><a class="header-anchor" href="#_2-2-linux发展历史" aria-hidden="true">#</a> 2.2 Linux发展历史</h3><figure><img src="https://simeis147-github-io.oss-cn-shenzhen.aliyuncs.com/project/reggietakeout/03linux/20230605132520.png" alt=" " tabindex="0" loading="lazy"><figcaption></figcaption></figure><ul><li><p>时间：1991年</p></li><li><p>地点：芬兰赫尔辛基大学</p></li><li><p>人物：Linus Torvalds（21岁）</p></li><li><p>语言：C语言、汇编语言</p></li><li><p>logo：企鹅</p></li><li><p>特点：免费、开源(源代码开放)、多用户(同时允许多个用户操作同一个Linux系统)、多任务(同时允许多个任务执行)</p></li></ul><h3 id="_2-3-linux系统版本" tabindex="-1"><a class="header-anchor" href="#_2-3-linux系统版本" aria-hidden="true">#</a> 2.3 Linux系统版本</h3><p>Linux系统的版本分为两种，分别是：<strong>内核版</strong> 和 <strong>发行版</strong>。</p><p><strong>1.</strong> 内核版</p><ul><li><p>由Linus Torvalds及其团队开发、维护</p></li><li><p>免费、开源</p></li><li><p>负责控制硬件</p></li></ul><p><strong>2.</strong> 发行版</p><ul><li><p>基于Linux内核版进行扩展</p></li><li><p>由各个Linux厂商开发、维护</p></li><li><p>有收费版本和免费版本</p></li></ul><p>我们使用Linux操作系统，实际上选择的是Linux的发行版本。在linux系统中，有各种各样的发行版本，具体如下：</p><table><thead><tr><th>发行版本</th><th>Logo</th><th>特点</th></tr></thead><tbody><tr><td>Ubuntu</td><td><img src="https://simeis147-github-io.oss-cn-shenzhen.aliyuncs.com/project/reggietakeout/03linux/20230605132843.png" alt=" " loading="lazy"></td><td>以桌面应用为主</td></tr><tr><td>RedHat</td><td><img src="https://simeis147-github-io.oss-cn-shenzhen.aliyuncs.com/project/reggietakeout/03linux/20230605132959.png" alt=" " loading="lazy"></td><td>应用最广泛、收费</td></tr><tr><td>CentOS</td><td><img src="https://simeis147-github-io.oss-cn-shenzhen.aliyuncs.com/project/reggietakeout/03linux/20230605133056.png" alt=" " loading="lazy"></td><td>RedHat的社区版、免费</td></tr><tr><td>openSUSE</td><td><img src="https://simeis147-github-io.oss-cn-shenzhen.aliyuncs.com/project/reggietakeout/03linux/20230605133109.png" alt=" " loading="lazy"></td><td>对个人完全免费、图形界面华丽</td></tr><tr><td>Fedora</td><td><img src="https://simeis147-github-io.oss-cn-shenzhen.aliyuncs.com/project/reggietakeout/03linux/20230605133127.png" alt=" " loading="lazy"></td><td>功能完备、快速更新、免费</td></tr><tr><td>红旗Linux</td><td><img src="https://simeis147-github-io.oss-cn-shenzhen.aliyuncs.com/project/reggietakeout/03linux/20230605133138.png" alt=" " loading="lazy"></td><td>北京中科红旗软件技术有限公司开发</td></tr></tbody></table><h2 id="_3-linux安装" tabindex="-1"><a class="header-anchor" href="#_3-linux安装" aria-hidden="true">#</a> 3. Linux安装</h2><h3 id="_3-1-安装方式介绍" tabindex="-1"><a class="header-anchor" href="#_3-1-安装方式介绍" aria-hidden="true">#</a> 3.1 安装方式介绍</h3><p>Linux系统的安装方式，主要包含以下两种：</p><figure><img src="https://simeis147-github-io.oss-cn-shenzhen.aliyuncs.com/project/reggietakeout/03linux/20230605133257.png" alt=" " tabindex="0" loading="lazy"><figcaption></figcaption></figure><table><thead><tr><th>方式</th><th>概述</th><th>场景</th></tr></thead><tbody><tr><td>物理机安装</td><td>直接将操作系统安装到服务器硬件上</td><td>企业开发中，服务器基本都是采用这种方式</td></tr><tr><td>虚拟机安装</td><td>通过虚拟机软件安装</td><td>没有自己服务器，学Linux，就可以安装在虚拟机上</td></tr></tbody></table><p><strong>虚拟机</strong>（Virtual Machine）指通过<strong>软件</strong>模拟的具有完整硬件系统功能、运行在完全隔离环境中的完整计算机系统。常用虚拟机软件：</p><ul><li>VMWare</li><li>VirtualBox</li><li>VMLite WorkStation</li><li>Qemu</li><li>HopeddotVOS</li></ul><h3 id="_3-2-安装vmware" tabindex="-1"><a class="header-anchor" href="#_3-2-安装vmware" aria-hidden="true">#</a> 3.2 安装VMware</h3><h3 id="_3-3-安装linux" tabindex="-1"><a class="header-anchor" href="#_3-3-安装linux" aria-hidden="true">#</a> 3.3 安装Linux</h3><h3 id="_3-4-网卡设置" tabindex="-1"><a class="header-anchor" href="#_3-4-网卡设置" aria-hidden="true">#</a> 3.4 网卡设置</h3><h3 id="_3-5-安装ssh连接工具" tabindex="-1"><a class="header-anchor" href="#_3-5-安装ssh连接工具" aria-hidden="true">#</a> 3.5 安装SSH连接工具</h3><h3 id="_3-6-linux目录结构" tabindex="-1"><a class="header-anchor" href="#_3-6-linux目录结构" aria-hidden="true">#</a> 3.6 Linux目录结构</h3><p>登录到Linux系统之后，我们需要先来熟悉一下Linux的目录结构。在Linux系统中，也是存在目录的概念的，但是Linux的目录结构和Windows的目录结构是存在比较多的差异的 在Windows目录下，是一个一个的盘符(C盘、D盘、E盘)，目录是归属于某一个盘符的。Linux系统中的目录有以下特点：</p><p><strong>A.</strong> / 是所有目录的顶点</p><p><strong>B.</strong> 目录结构像一颗倒挂的树</p><p><strong>Linux 和 Windows的目录结构对比:</strong></p><figure><img src="https://simeis147-github-io.oss-cn-shenzhen.aliyuncs.com/project/reggietakeout/03linux/20230607171906.png" alt=" " tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>Linux的目录结构，如下：</p><figure><img src="https://simeis147-github-io.oss-cn-shenzhen.aliyuncs.com/project/reggietakeout/03linux/20230607171930.png" alt=" " tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>根目录/ 下各个目录的作用及含义说明:</p><table><thead><tr><th>编号</th><th>目录</th><th>含义</th></tr></thead><tbody><tr><td>1</td><td>/bin</td><td>存放二进制可执行文件</td></tr><tr><td>2</td><td>/boot</td><td>存放系统引导时使用的各种文件</td></tr><tr><td>3</td><td>/dev</td><td>存放设备文件</td></tr><tr><td>4</td><td>/etc</td><td>存放系统配置文件</td></tr><tr><td>5</td><td>/home</td><td>存放系统用户的文件</td></tr><tr><td>6</td><td>/lib</td><td>存放程序运行所需的共享库和内核模块</td></tr><tr><td>7</td><td>/opt</td><td>额外安装的可选应用程序包所放置的位置</td></tr><tr><td>8</td><td>/root</td><td>超级用户目录</td></tr><tr><td>9</td><td>/sbin</td><td>存放二进制可执行文件，只有root用户才能访问</td></tr><tr><td>10</td><td>/tmp</td><td>存放临时文件</td></tr><tr><td>11</td><td>/usr</td><td>存放系统应用程序</td></tr><tr><td>12</td><td>/var</td><td>存放运行时需要改变数据的文件，例如日志文件</td></tr></tbody></table><h2 id="_4-linux常用命令" tabindex="-1"><a class="header-anchor" href="#_4-linux常用命令" aria-hidden="true">#</a> 4. Linux常用命令</h2><h3 id="_4-1-linux命令初体验" tabindex="-1"><a class="header-anchor" href="#_4-1-linux命令初体验" aria-hidden="true">#</a> 4.1 Linux命令初体验</h3><h4 id="_4-1-1-常用命令演示" tabindex="-1"><a class="header-anchor" href="#_4-1-1-常用命令演示" aria-hidden="true">#</a> 4.1.1 常用命令演示</h4><table><thead><tr><th>序号</th><th>命令</th><th>对应英文</th><th>作用</th></tr></thead><tbody><tr><td>1</td><td>ls [目录名]</td><td>list</td><td>查看当前目录下的内容</td></tr><tr><td>2</td><td>pwd</td><td>print work directory</td><td>查看当前所在目录</td></tr><tr><td>3</td><td>cd [目录名]</td><td>change directory</td><td>切换目录</td></tr><tr><td>4</td><td>touch [文件名]</td><td>touch</td><td>如果文件不存在,创建文件</td></tr><tr><td>5</td><td>mkdir [目录名]</td><td>make directory</td><td>创建目录</td></tr><tr><td>6</td><td>rm [文件名]</td><td>remove</td><td>删除指定文件</td></tr></tbody></table><h4 id="_4-1-2-linux命令使用技巧" tabindex="-1"><a class="header-anchor" href="#_4-1-2-linux命令使用技巧" aria-hidden="true">#</a> 4.1.2 Linux命令使用技巧</h4><p>在我们使用Linux系统命令时，可以使用以下几个技巧：</p><ol><li><p>Tab键自动补全</p></li><li><p>连续两次Tab键，给出操作提示</p></li><li><p>使用上下箭头快速调出曾经使用过的命令</p></li><li><p>使用clear命令或者Ctrl+l快捷键实现清屏</p></li></ol><h4 id="_4-1-3-linux命令格式" tabindex="-1"><a class="header-anchor" href="#_4-1-3-linux命令格式" aria-hidden="true">#</a> 4.1.3 Linux命令格式</h4><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>command <span class="token url">[<span class="token content">-options</span>] [<span class="token variable">parameter</span>]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>备注:</p><p>​用户的home目录</p><p>​root用户 /root</p><p>​其他用户 /home/xxx</p></blockquote><p>cd .. 切换到当前目录位置的上级目录; 可以通过 cd ../.. 来切换到上级目录的上级目录。</p><h4 id="_4-2-3-cat" tabindex="-1"><a class="header-anchor" href="#_4-2-3-cat" aria-hidden="true">#</a> 4.2.3 cat</h4><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>作用: 用于显示文件内容
语法: cat [-n] fileName
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>cat 指令会一次性查看文件的所有内容，如果文件内容比较多，这个时候查看起来就不是很方便了，这个时候我们可以通过一个新的指令more。</p><h4 id="_4-2-4-more" tabindex="-1"><a class="header-anchor" href="#_4-2-4-more" aria-hidden="true">#</a> 4.2.4 more</h4><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>作用: 以分页的形式显示文件内容
语法: more fileName
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当我们在查看一些比较大的文件时，我们可能需要经常查询文件尾部的数据信息，那这个时候如果文件很大，我们要一直向下翻页，直到最后一页，去看最新添加的数据，这种方式就比较繁琐了，此时，我们可以借助于tail指令。</p><h4 id="_4-2-5-tail" tabindex="-1"><a class="header-anchor" href="#_4-2-5-tail" aria-hidden="true">#</a> 4.2.5 tail</h4><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>作用: 查看文件末尾的内容
语法: tail [-f] fileName
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>操作示例:</strong></p><figure><img src="https://simeis147-github-io.oss-cn-shenzhen.aliyuncs.com/project/reggietakeout/03linux/20230607173104.png" alt=" " tabindex="0" loading="lazy"><figcaption></figcaption></figure>`,103);function v(m,p){const a=d("font");return s(),r("div",null,[o,i("p",null,[i("strong",null,[e("对于Linux的常用指令的学习，最好的学习方法就是："),l(a,{color:"red",size:"7"},{default:c(()=>[e("多敲")]),_:1})])]),h])}const x=t(u,[["render",v],["__file","day01.html.vue"]]);export{x as default};
