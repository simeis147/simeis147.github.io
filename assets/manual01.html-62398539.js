import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as c,c as l,e as n,f as s,d as e,b as p}from"./app-a8acb571.js";const o="/assets/bg2015120901-62c94bc4.png",u={},d=p('<h1 id="常用git命令清单" tabindex="-1"><a class="header-anchor" href="#常用git命令清单" aria-hidden="true">#</a> 常用Git命令清单</h1><p>一般来说，日常使用只要记住下图6个命令，就可以了。但是熟练使用，恐怕要记住60～100个命令。</p><figure><img src="'+o+`" alt=" " tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>下面是我整理的常用 Git 命令清单。几个专用名词的译名如下。</p><blockquote><ul><li>Workspace：工作区</li><li>Index / Stage：暂存区</li><li>Repository：仓库区（或本地仓库）</li><li>Remote：远程仓库</li></ul></blockquote><h2 id="一、新建代码库" tabindex="-1"><a class="header-anchor" href="#一、新建代码库" aria-hidden="true">#</a> 一、新建代码库</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 在当前目录新建一个Git代码库</span>
