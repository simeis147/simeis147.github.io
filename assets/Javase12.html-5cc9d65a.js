...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AnnoDemo2</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_40-4-元注解" tabindex="-1"><a class="header-anchor" href="#_40-4-元注解" aria-hidden="true">#</a> 40.4 元注解</h3><p>可以写在注解上面的注解</p><p>@Target ：指定注解能在哪里使用</p><p>@Retention ：可以理解为保留时间(生命周期)</p><p><strong>Target</strong>：</p><p>作用：用来标识注解使用的位置，如果没有使用该注解标识，则自定义的注解可以使用在任意位置。</p><p>可使用的值定义在ElementType枚举类中，常用值如下</p><ul><li>TYPE，类，接口</li><li>FIELD, 成员变量</li><li>METHOD, 成员方法</li><li>PARAMETER, 方法参数</li><li>CONSTRUCTOR, 构造方法</li><li>LOCAL_VARIABLE, 局部变量</li></ul><p><strong>Retention</strong>：</p><p>作用：用来标识注解的生命周期(有效范围)</p><p>可使用的值定义在RetentionPolicy枚举类中，常用值如下</p><ul><li>SOURCE：注解只作用在源码阶段，生成的字节码文件中不存在</li><li>CLASS：注解作用在源码阶段，字节码文件阶段，运行阶段不存在，默认值</li><li>RUNTIME：注解作用在源码阶段，字节码文件阶段，运行阶段</li></ul>`,104);function u(k,d){return a(),t("div",null,[l,p(" more "),i])}const v=s(o,[["render",u],["__file","Javase12.html.vue"]]);export{v as default};
