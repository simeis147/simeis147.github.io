...
1. **创建工程，并在 `pom.xml` 配置文件中配置所依赖的坐标**
    ...
    ![ ](./assets/springboot08/image-20210911132335452.png)
...
3. **编写 `SpringMVC` 的配置类**
    ...
    ![ ](./assets/springboot08/image-20210911133219847.png)
...
![ ](./assets/springboot08/image-20210911172200292.png)
...
![ ](./assets/springboot08/image-20210911180828611.png)
...
![ ](./assets/springboot08/image-20210911181714437.png)
...
![ ](./assets/springboot08/image-20210918220338109.png)
...
![ ](./assets/springboot08/image-20210918220855024.png)

再进入到该父工程中，在该工程中我们可以看到配置内容结构如下图所示

![ ](./assets/springboot08/image-20210918221042947.png)

上图中的 `properties` 标签中定义了各个技术软件依赖的版本，避免了我们在使用不同软件技术时考虑版本的兼容问题。在 `properties` 中我们找 `servlet`  和 `mysql` 的版本如下图

![ ](./assets/springboot08/image-20210918221511249.png)
...
![ ](./assets/springboot08/image-20210918221942453.png)
