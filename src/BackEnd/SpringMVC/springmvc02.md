...
* 如何解决上述问题?
  ...
  * 设置错误提示级别
    ...
    ![ ](./assets/springmvc02/1630600227357.png)
...
对象图书模块的增删改查模块就已经完成了编写，我们可以从后往前写也可以从前往后写，最终只需要能把功能实现即可。如果有人问题，正确的回答应该是`先写Service然后再写Dao，写完要经过单元测试后再写Controller`.
...
![ ](./assets/springmvc02/1630600844191.png)

查询所有，测试的结果为:

![ ](./assets/springmvc02/1630600927486.png)
...
![ ](./assets/springmvc02/1630652582425.png)
...
![ ](./assets/springmvc02/1630652758221.png)

#### 删除

`http://localhost/books/14`

![ ](./assets/springmvc02/1630652796605.png)

#### 查询单个

`http://localhost/books/1`

![ ](./assets/springmvc02/1630652837682.png)
...
* 在Controller层增删改返回给前端的是boolean类型数据
  ...
  ![ ](./assets/springmvc02/1630653359533.png)

* 在Controller层查询单个返回给前端的是对象

  ![ ](./assets/springmvc02/1630653385377.png)

* 在Controller层查询所有返回给前端的是集合对象对象

  ![ ](./assets/springmvc02/1630653468887.png)
...
**注意:**Result类名及类中的字段并不是规定的，可以根据需要自行增减提供若干个构造方法，方便操作。
...
因为这个项目环境的内容和SSM整合的内容是一致的，所以我们就不在把代码粘出来了，大家在练习的时候可以之间在前面整合的例子案例环境下，进行本节内容的开发。

最终创建好的项目结构如下:

![ ](./assets/springmvc02/1630654870632.png)

#### 2.2.2 结果封装

对于结果封装，我们应该是在变现层进行处理，所以我们把结果类放在controller包下，当然你也可以放在domain包，这个都是可以的，具体如何实现结果封装，具体的步骤为:
...
![ ](./assets/springmvc02/1630656982337.png)
...
![ ](./assets/springmvc02/1630657972564.png)
...
![ ](./assets/springmvc02/1630658350945.png)
...
![ ](./assets/springmvc02/1630658606549.png)
...
![ ](./assets/springmvc02/1630659060451.png)
...
* 业务异常（BusinessException）
  ...
  * 规范的用户行为产生的异常
    ...
    * 如用户在页面输入内容的时候未按照指定格式进行数据填写，如在年龄框输入的是字符串
      ...
      ![ ](./assets/springmvc02/1630659599983.png)

  * 不规范的用户行为操作产生的异常

    * 如用户故意传递错误数据

      ![ ](./assets/springmvc02/1630659622958.png)
...
* 其他异常（Exception）
  ...
  * 编程人员未预期到的异常，如:用到的文件不存在
    ...
    ![ ](./assets/springmvc02/1630659690341.png)
...
![ ](./assets/springmvc02/1630661162758.png)
...
![ ](./assets/springmvc02/1630661781776.png)
...
![ ](./assets/springmvc02/1630666787456.png)
...
* 这个拦截器和我们之前说的AOP思想是一致的，所以说拦截器也是对AOP思想的实现。
...
![ ](./assets/springmvc02/1630676903190.png)
...
![ ](./assets/springmvc02/1630677370998.png)
...
![ ](./assets/springmvc02/1630679464294.png)
...
![ ](./assets/springmvc02/1630680579735.png)
