...
以内存为基准，分为`输入input` 和`输出output` ，即流向内存是输入流，流出内存的输出流。
...
public class FOSWrite {
    public static void main(String[] args) throws IOException {
        ...
        // 写出从索引2开始，2个字节。索引2是c，两个字节，也就是 cd。
        fos.write(b);
        // 关闭资源
        fos.close();
    }
...
![1_charset](./assets/1_charset.jpg)
...
![2_zhuanhuan](./assets/2_zhuanhuan.jpg)
...
![3_xuliehua](./assets/3_xuliehua.jpg)

#### 28.3.1 ObjectOutputStream类
